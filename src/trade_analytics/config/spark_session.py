...
def get_spark(app_name: str = "TradeAnalyticsLakehouse") -> SparkSession:
    ...
    is_databricks = (
        spark_env != "local" and "DATABRICKS_RUNTIME_VERSION" in os.environ  # Or actual Databricks
    )
    ...
    if is_databricks:
        ...
        try:
            ...
            raise RuntimeError("delta-spark not installed. Run: pip install delta-spark")
